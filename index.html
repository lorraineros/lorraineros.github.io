...
<body>
    ...
    <header>
        ...
        <picture>
                <img src="img/beautifulcat.png" alt="cat">
            </picture>
    </header>
    <section class="content">
        ...
        <picture class="comics">
            <div><img class="c1" src="img/comic1.png" alt="comic"></div>
            <div><img class="c2" src="img/comic2.png" alt="comic"></div>
            <div><img class="c3" src="img/comic3.png" alt="comic"></div>
            <div><img class="c4" src="img/comic4.png" alt="comic"></div>
            <div><img class="c5" src="img/comic5.png" alt="comic"></div>
            <div><img class="c6" src="img/comic6.png" alt="comic"></div>
        </picture>
        </article>
